...
<div class="row" style="background-color: rgba(232, 232, 232, 0.3);padding: 6px;">
	...
	<div class="col-xs-1"  valign="center">
		<button title="Clic para editar el post" onclick="mostrarEditarPost('<?php echo $postCuerpo; ?>','<?php echo $idPost; ?>')" class="glyphicon glyphicon-pencil btn btn-default" ></button>
	</div>
